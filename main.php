...
<html lang="en">
  ...
  <body>
    ...
    <div href="profile.html" class="sign-container">
    ...
    <main id="content" class="profile-container">
        ...
        <section class="search-section">
            <form class="search-form" action="main.php" method="GET" class="search-form">
                <div class="form-section">
                <div class="form-row">
                    <input type="text" name="search_text" placeholder="Αναζήτηση τίτλου" value="<?php echo htmlspecialchars($search_results['search_params']['search_text']); ?>">
